...
if __name__ == '__main__':
    ...
    if len(points) <= 51:
        ...
        solution_value, solution = mytsp.localsearch_multistart(10, opt=2)
        solution_value, solution = mytsp.three_opt(solution, solution_value)
    elif len(points) <= 574:
        solution_value, solution = mytsp.localsearch_multistart(3, opt=2)
        ...
        solution_value, solution = mytsp.localsearch_multistart(1, opt=2)
        #solution_value, solution = read_sol(path.split('.')[0] + "_solution.txt", len(points))
        solution_value, solution = mytsp.simu_two_opt(solution, solution_value, max_time=15., tempe=10.)
        solution_value, solution = mytsp.two_opt(solution, solution_value)
    else:
        # solution_value, solution = read_sol(path.split('.')[0] + "_solution.txt", len(points))
        solution_value, solution = mytsp.nearest_neighbor()
        solution_value, solution = mytsp.two_opt(solution, solution_value, max_time=5.)
